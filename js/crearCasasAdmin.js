const conten2 = document.querySelector('#contened');
...
function mostrarCasasAdmin(ObCasas) {
    removerCasas();
    ObCasas.forEach(ObCasa => {
        ...
        <div class="card h-100">
            ...
            class="card-img-top" alt="..." />
                ...
                <a href="../FormulariosCasas/editarCasa.html" class="btn btn-primary active" role="button" aria-pressed="true">Editar</a>
...
function removerCasas() {
  while (conten2.firstChild) {
    conten2.removeChild(conten2.firstChild);
  };
};
